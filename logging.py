...
if __name__ == "logging" and not __package__:
    import importlib.util
    import os
    import sys

    stdlib_path = os.path.join(os.path.dirname(os.__file__), "logging", "__init__.py")
    spec = importlib.util.spec_from_file_location(
        __name__, stdlib_path, submodule_search_locations=[os.path.dirname(stdlib_path)]
    )
    if spec is None or spec.loader is None:
        raise ImportError("Unable to load standard library logging module")
